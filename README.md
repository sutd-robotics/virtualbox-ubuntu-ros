...
6. Run the following commands sequentially. For convenience, you may want to enable `Host to Guest` clipboard via `Devices > Shared Clipboard > Host to Guest `, allowing you to copy from Windows and paste in Ubuntu. Alternatively, you can navigate to this page on Firefox in the virtual machine to copy and paste the commands.
